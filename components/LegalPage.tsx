  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-3xl px-6 py-20 lg:py-28">
        ...
        <p className="mt-6 text-lg leading-relaxed text-fg-2">{intro}</p>
        ...
        <div className="mt-14 space-y-12">
          {sections.map((s, i) => (
            <section key={s.heading} id={slug(s.heading)} className="scroll-mt-32">
        ...
        <p className="mt-16 border-t border-fg-2/10 pt-8 text-sm leading-relaxed text-subtle">
          {footnote}
        </p>
      </article>
    </>
